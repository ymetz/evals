...
declare -A MODEL_CHECKPOINTS=(
    ...
    ["Apertus-8B-10.2T-newcooldown-mixture1-fast-adam"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-1-fast-adam/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-1-bs512-lr5e-06-maxgnorm1.0-epochs1-adamw_torch/checkpoints/7f2faa33edb7f13e/checkpoint-1622"
    ["Apertus-8B-10.2T-newcooldown-mixture2-fast-adam"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-2-fast-adam/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-2-bs512-lr5e-06-maxgnorm1.0-epochs1-adamw_torch/checkpoints/44532e711f8d5bee/checkpoint-3914"
    ["Apertus-8B-10.2T-newcooldown-mixture3-fast-adam"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-3-fast-adam/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-3-bs512-lr5e-06-maxgnorm1.0-epochs1-adamw_torch/checkpoints/7a61ceff935a6765/checkpoint-4577"
    ...
    ["Apertus-8B-10.2T-newcooldown-mixture1-fast-ademamix"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-1-fast-ademamix/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-1-bs512-lr5e-06-maxgnorm1.0-epochs1-ademamix/checkpoints/ee969b526b1995f7/checkpoint-1622"
    ["Apertus-8B-10.2T-newcooldown-mixture2-fast-ademamix"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-2-fast-ademamix/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-2-bs512-lr5e-06-maxgnorm1.0-epochs1-ademamix/checkpoints/53e2ead7db07314d/checkpoint-3914"
    ["Apertus-8B-10.2T-newcooldown-mixture3-fast-ademamix"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-3-fast-ademamix/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-3-bs512-lr5e-06-maxgnorm1.0-epochs1-ademamix/checkpoints/8df0b5c9349b8015/checkpoint-4577"
    ["Apertus-8B-10.2T-newcooldown-mixture4-fast-ademamix"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/apertus-sft-mixture-4-fast-ademamix/Apertus8B-tokens10.2T-it2059810-newcooldown-apertus-sft-mixture-4-bs512-lr5e-06-maxgnorm1.0-epochs1-ademamix/checkpoints/1ce7109f7dde7ed2/checkpoint-4792"
...
#    ["Apertus-70B-15T-swissai-tulu-3-ademamix-new"]=Coming soon... @Skander
    ...
    ["Apertus-70B-15T-mixture4-fast-ademamix"]="/iopsstor/scratch/cscs/smoalla/projects/swiss-alignment/artifacts/shared/outputs/train_sft/fix-ademamix-fast-noquote/Apertus70B-tokens15T-it1155828-apertus-sft-mixture-4-bs512-lr2e-06-maxgnorm1-epochs1-ademamix/checkpoints/0bc386f8352f3273/checkpoint-4792"
